...
- [ ] `T1` Capture the current cold/warm transition and identify the invalid frame. Size S, effort high, deps none, parallel-ok false. Perf: measure focus-to-commit and zoom-out; do not alter timing yet.
- [ ] `T2` Obtain independent host/webview and optical-timing diagnoses. Size S, effort medium (ECONOMY ceiling), deps T1, parallel-ok true. Perf: proposals must avoid extra boot I/O and frame-bound JS work.
